 ...
 * Description:
 */
public class RecordWaitFragment extends BaseFragment<IRecordView, RecordPresenter> implements IRecordView {
        ...
        adapter.setOnItemClickListener(new HomeRecycleAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                if (record != null) {
                    ...
                    intent.setClass(RecordWaitFragment.this.getActivity(), PageActivity.class);
